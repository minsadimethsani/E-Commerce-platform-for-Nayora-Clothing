            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex items-center gap-6 mb-12">
                ...
                <span className={`text-xs font-bold px-2 py-0.5 rounded-full inline-block ${
                  (firstProduct as any).quantity > 10 ? 'bg-green-100 text-green-800' : 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="flex flex-col justify-center order-2 lg:order-1">
              ...
              <div className="flex items-center gap-6 mb-12">
                ...
                <span className={`text-xs font-bold px-2 py-0.5 rounded-full inline-block ${
                  (secondProduct as any).quantity > 10 ? 'bg-green-100 text-green-800' : 
            ...
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-espresso/5 order-1 lg:order-2">
              <Image 
